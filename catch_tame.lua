...
-- === CONFIGURATION ===
local KEY_LIST_URL = "https://raw.githubusercontent.com/N0icej/neora_catchtame/main/keys.txt" -- CHANGE THIS TO YOUR RAW KEY FILE URL
...
local function checkKey(key)
    ...
    local success, data = pcall(game.HttpGet, game:HttpGet, KEY_LIST_URL)
